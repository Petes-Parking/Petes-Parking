...
<div id="box" class="container" style="background-color: #CEB888; border-radius: 10px; display: inline-block; vertical-align: top; margin-top: .8%; height: 90%; width: 75%; margin-left: 1%;">

  <h2 style="padding: 30px; margin-top: 2%;">Parking List</h2>
  <%@include file="businessMessage.jsp" %>
  <table class="table text-dark" bgcolor="#CEB888" style="margin-top: 3%; padding-bottom: 5%; margin-bottom: 5%; width: 90%; margin-left: 5%">
    <thead style="background-color: #9D968D; color: black;">
    <tr>
    ...
    <tbody class="table-striped" style="background-color: white; color: black">
